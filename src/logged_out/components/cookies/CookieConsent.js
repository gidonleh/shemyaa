    ...
    <Snackbar
      ...
      message={
        <Typography className="text-white">
          באתר זה נעשה שימוש ב"עוגיות" על מנת לספק לכם חוויית משתמש מקסימלית.
          {" "}
        </Typography>
      }
      action={
        <Fragment>
          <Box mr={1}>
            <Button style={{color: myYellow}} onClick={handleCookieRulesDialogOpen}>
              פרטים נוספים
            </Button>
          </Box>
          <Button style={{color: myYellow}} color={myYellow} onClick={onAccept}>
            תודה!
          </Button>
        </Fragment>
      }
